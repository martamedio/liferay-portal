...
public class AssignSimpleScopesDisplayContext
	...
	public AssignSimpleScopesDisplayContext(
		...
		ScopeAliasScopeDescriptor scopeAliasScopeDescriptor =
			new ScopeAliasScopeDescriptor(
				_companyId, scopeDescriptorLocator, scopeLocator);

		Map<String, String> scopeAliasesDescription = new HashMap<>();

		for (String scopeAlias : scopeAliases) {
			String description = scopeAliasScopeDescriptor.getDescription(
				scopeAlias, _locale, "<br />");

			scopeAliasesDescription.put(scopeAlias, description);
		}

		_availableScopeAliases = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);

		_availableScopeAliases.putAll(scopeAliasesDescription);
	}
	...
	public Map<String, String> getAvailableScopeAliases() {
	...
	private final Map<String, String> _availableScopeAliases;
