...
public class CORSApplicationClientTest extends BaseClientTestCase {
	...
	@Test
	public void testDefaultApplicationCORS() throws Exception {
	...
	public static class CORSApplicationTestPreparatorBundleActivator
		...
		protected void prepareTest() throws Exception {
			...
			properties.put("cors.allow.origin", _TEST_CORS_URI);
			properties.put("cors.allow.methods", "authentication,GET");

			registerJaxRsApplication(
				new TestApplication(), "cors", properties);
			registerJaxRsApplication(
