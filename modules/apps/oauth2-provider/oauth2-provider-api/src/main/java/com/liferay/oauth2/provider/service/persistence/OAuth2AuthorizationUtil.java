...
public class OAuth2AuthorizationUtil {
	...
	/**
	 * Returns all the o auth2 authorizations where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	...
	/**
	 * Returns a range of all the o auth2 authorizations where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuth2AuthorizationModelImpl</code>.
	 * </p>
	...
	public static List<OAuth2Authorization> findByOAuth2ApplicationId(
		...
		return getPersistence().findByOAuth2ApplicationId(
			companyId, oAuth2ApplicationId, start, end);
	}

	/**
	 * Returns an ordered range of all the o auth2 authorizations where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuth2AuthorizationModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first o auth2 authorization in the ordered set where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param oAuth2ApplicationId the o auth2 application ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	/**
	 * Returns the last o auth2 authorization in the ordered set where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param oAuth2ApplicationId the o auth2 application ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	/**
	 * Returns the o auth2 authorizations before and after the current o auth2 authorization in the ordered set where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * @param oAuth2AuthorizationId the primary key of the current o auth2 authorization
	 * @param companyId the company ID
	 * @param oAuth2ApplicationId the o auth2 application ID
	...
	public static OAuth2Authorization[] findByOAuth2ApplicationId_PrevAndNext(
		...
		return getPersistence().findByOAuth2ApplicationId_PrevAndNext(
			oAuth2AuthorizationId, companyId, oAuth2ApplicationId,
			orderByComparator);
	}

	/**
	 * Removes all the o auth2 authorizations where companyId = &#63; and oAuth2ApplicationId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param oAuth2ApplicationId the o auth2 application ID
	 */
	public static void removeByOAuth2ApplicationId(
		long companyId, long oAuth2ApplicationId) {

		getPersistence().removeByOAuth2ApplicationId(
			companyId, oAuth2ApplicationId);
	}

	/**
	 * Returns the number of o auth2 authorizations where companyId = &#63; and oAuth2ApplicationId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param oAuth2ApplicationId the o auth2 application ID
	 * @return the number of matching o auth2 authorizations
	 */
	public static int countByOAuth2ApplicationId(
		long companyId, long oAuth2ApplicationId) {

		return getPersistence().countByOAuth2ApplicationId(
			companyId, oAuth2ApplicationId);
	}
	...
	public static void removeByAccessTokenContentHash(
		...
		getPersistence().removeByAccessTokenContentHash(
			companyId, accessTokenContentHash);
	}
