...
create index IX_26BF597D on OAuth2ApplicationScopeAliases (companyId, oAuth2ApplicationId);
...
create index IX_D861B8FC on OAuth2Authorization (companyId, oAuth2ApplicationId);
