...
<aui:fieldset>
	...
	<aui:input helpMessage="email-template-from-name-description" label="email-template-from-name" name="emailTemplateFromName" type="text" value="<%= emailOTPConfiguration.emailTemplateFromName() %>" />
