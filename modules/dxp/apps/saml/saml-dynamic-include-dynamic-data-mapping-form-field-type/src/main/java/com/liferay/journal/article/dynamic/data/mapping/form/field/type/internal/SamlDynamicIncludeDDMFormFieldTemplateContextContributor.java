 ...
 */
@Component(
	immediate = true, property = "ddm.form.field.type.name=saml_dynamic_include",
	service = {
		DDMFormFieldTemplateContextContributor.class,
		SamlDynamicIncludeDDMFormFieldTemplateContextContributor.class
	}
)
public class SamlDynamicIncludeDDMFormFieldTemplateContextContributor
